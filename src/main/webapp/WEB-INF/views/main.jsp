        ...
        <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="${path}/resources/img/slide.jpg" class="d-block w-100"
                         style="image-rendering:smooth;height: 330px" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="${path}/resources/img/slide2.jpg" class="d-block w-100"
                         style="image-rendering:smooth;height: 330px" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="${path}/resources/img/slide3.jpg" class="d-block w-100" style="height: 330px" alt="...">
                </div>
            </div>
