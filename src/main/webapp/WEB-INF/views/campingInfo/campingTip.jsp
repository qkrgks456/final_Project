		...
		<div class="row">
			<div class="col-4 border-end border-black text-center"
				...
				<div class="btn-group mt-2" role="group"
					...
					<button id="first" type="button" class="btn btn-warning">처음</button>
...
<script>
	...
	function printList1(i, data) {
		var el = document.createElement('div'), content = "<div class='card border-dark'  style='cursor:pointer; height:300px;'>";
	...
	function listPrint(index, data) {
		var el = document.createElement('div'), content = "<div class='card border-dark text-center'  style='cursor:pointer; height:300px;'>";
